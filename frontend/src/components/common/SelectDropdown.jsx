    ...
    <DropdownMenu.Root>
      <DropdownMenu.Trigger asChild>
        <button
          type="button"
          className={clsx(
           "flex h-[46px] min-w-0 items-center justify-between gap-3 rounded-xl border border-slate-200 bg-white px-3 text-left text-sm text-slate-700 shadow-sm outline-none transition hover:bg-slate-50 focus:border-[#5e6ad2]/70 focus:ring-4 focus:ring-[#5e6ad2]/10",
            className
          )}
        >
